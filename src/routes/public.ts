...
const checkRegistration = [
	...
	body('role').isIn([USER_ROLE.ADMIN, USER_ROLE.USER]).withMessage('Invalid role')
] 
...
export default () => {
	...
	router.post('/registration', checkRegistration, async (req: Request, res: Response, _next: NextFunction) => {
		...
		const response = {id: newUser.id, email: newUser.email, role: newUser.role} 
